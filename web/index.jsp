...
<html>
    ...
    <body class="login-bg">
        ...
        <script>
            ...
            // Validar CAPTCHA - VERSIÓN MEJORADA
            function validarCaptcha() {
                const input = document.getElementById('captchaInput').value.trim();

                console.log("🔐 Validando CAPTCHA en frontend:");
                console.log("   - Input:", "'" + input + "'");
                console.log("   - Código esperado:", "'" + captchaCode + "'");
                console.log("   - Coinciden:", input === captchaCode);

                if (input === '' || input !== captchaCode) {
                    console.log("❌ CAPTCHA incorrecto en frontend");
                ...
                console.log("✅ CAPTCHA correcto en frontend - Procediendo con login");
            ...
            // SOLUCIÓN ALTERNATIVA: Usar URLSearchParams en lugar de FormData
            function enviarLoginFinal() {
                console.log("🚀 Iniciando envío de login (SOLUCIÓN ALTERNATIVA)...");
                ...
                console.log("🔍 VERIFICANDO URLSearchParams:");
            ...
            // Mostrar mensaje de error - CORREGIDO (FALTA EL MENSAJE)
